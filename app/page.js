    ...
    <main>
      <section style={{display:"grid",gridTemplateColumns:"1fr 1fr",minHeight:"92vh"}}>
        <div style={{padding:"6rem 5rem",display:"flex",flexDirection:"column",justifyContent:"center"}}>
          <p style={{color:"#C6A962",fontSize:"0.65rem",letterSpacing:"0.3em",textTransform:"uppercase",marginBottom:"1.5rem",fontFamily:"Arial,sans-serif"}}>Premium Gifting and Events Dhaka</p>
          <h1 style={{fontSize:"3.5rem",lineHeight:1.15,fontWeight:700,marginBottom:"1.5rem",fontFamily:"Georgia,serif"}}>Never miss a moment that matters.</h1>
          <p style={{color:"#888",fontSize:"0.9rem",lineHeight:1.8,maxWidth:"420px",marginBottom:"2.5rem",fontFamily:"Arial,sans-serif"}}>Bangladesh first luxury gifting and event platform. Bespoke gifts, curated celebrations delivered with perfection.</p>
      ...
      <section style={{padding:"5rem 4rem",background:"#0D0D0D"}}>
        ...
        <h2 style={{fontFamily:"Georgia,serif",fontSize:"2.2rem",fontWeight:700,marginBottom:"0.5rem"}}>What are you looking for?</h2>
        <p style={{color:"#888",fontSize:"0.85rem",marginBottom:"2.5rem",fontFamily:"Arial,sans-serif"}}>Gifts, events, surprises find exactly what you need</p>
        <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:"1px",background:"#1e1e1e"}}>
          {categories.map((cat, i) => (
            <Link key={i} href={"/shop?category=" + cat.name} style={{textDecoration:"none",background:"#0D0D0D",padding:"2rem 1.5rem",display:"flex",flexDirection:"column",alignItems:"center",textAlign:"center"}}>
              <div style={{width:"56px",height:"56px",borderRadius:"50%",background:"rgba(198,169,98,0.08)",border:"0.5px solid rgba(198,169,98,0.2)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.5rem",marginBottom:"1rem"}}>{cat.icon}</div>
        ...
        <div style={{textAlign:"center",marginTop:"2rem"}}>
          <Link href="/shop" className="btn-outline">View All Products and Services</Link>
        </div>
      </section>

      <section style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)"}}>
        {[
          {icon:"🎁",title:"Send a Gift",desc:"Flowers, luxury items and bundles delivered across Dhaka",href:"/shop"},
      ...
      <section style={{padding:"5rem 4rem",background:"#111"}}>
        ...
        <h2 style={{fontFamily:"Georgia,serif",fontSize:"2.2rem",fontWeight:700,marginBottom:"0.5rem"}}>Save dates. Never forget again.</h2>
        <p style={{color:"#888",fontSize:"0.85rem",marginBottom:"2rem",maxWidth:"520px",fontFamily:"Arial,sans-serif",lineHeight:1.7}}>Add loved ones birthdays and anniversaries. We remind you before its too late.</p>
        <div style={{display:"flex",gap:"1rem"}}>
      ...
      <div style={{background:"rgba(198,169,98,0.04)",borderTop:"0.5px solid #8A7340",borderBottom:"0.5px solid #8A7340",padding:"1.2rem 4rem",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
        <div style={{display:"flex",alignItems:"center",gap:"1rem"}}>
          ...
          <div style={{color:"#888",fontSize:"0.78rem",fontFamily:"Arial,sans-serif"}}>Smart Reminders Active - SMS and Email 7 days, 2 days and same day before every saved moment</div>
        </div>
      ...
      <footer style={{padding:"4rem",borderTop:"0.5px solid #1e1e1e",background:"#0D0D0D"}}>
        <div style={{display:"grid",gridTemplateColumns:"2fr 1fr 1fr 1fr",gap:"3rem",marginBottom:"3rem"}}>
          <div>
            ...
            <p style={{color:"#555",fontSize:"0.72rem",lineHeight:1.7,fontFamily:"Arial,sans-serif"}}>Bangladesh premium gifting and event platform. Based in Dhaka.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <Link href="#" style={{display:"block",color:"#888",fontSize:"0.72rem",textDecoration:"none",marginBottom:"0.5rem",fontFamily:"Arial,sans-serif"}}>About Us</Link>
            <Link href="/blog" style={{display:"block",color:"#888",fontSize:"0.72rem",textDecoration:"none",marginBottom:"0.5rem",fontFamily:"Arial,sans-serif"}}>Blog</Link>
            <Link href="/moments" style={{display:"block",color:"#888",fontSize:"0.72rem",textDecoration:"none",marginBottom:"0.5rem",fontFamily:"Arial,sans-serif"}}>Special Moments</Link>
            <Link href="/dashboard" style={{display:"block",color:"#888",fontSize:"0.72rem",textDecoration:"none",marginBottom:"0.5rem",fontFamily:"Arial,sans-serif"}}>Track Order</Link>
          </div>
        </div>
